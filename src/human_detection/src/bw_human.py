...
def process_img_msg_sync(img_msg, depth_image, args):
    start = time.time()
    image_pub = args
    np_img_orig = bridge_color.imgmsg_to_cv2(
        img_msg, desired_encoding='rgb8'
    ...
    ret,thresh = cv2.threshold(img_normalized,70,255,0)
    ...
    masked_image_msg.header.frame_id = depth_image.header.frame_id
...
if __name__ == "__main__":
    ...
    ts.registerCallback(process_img_msg_sync, (image_pub))
